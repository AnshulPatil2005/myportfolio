...
export const metadata: Metadata = {
  title: "Photos | Anshul Patil",
  metadataBase: new URL("https://anshulpatil.dev/photos"),
  description: "Explore photos from Anshul Patil",
  openGraph: {
    title: "Photos | Anshul Patil",
    url: "https://anshulpatil.dev/photos",
    description: "Explore photos from Anshul Patil",
  },
};
