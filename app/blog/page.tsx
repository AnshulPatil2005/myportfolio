...
export const metadata: Metadata = {
  title: "Blog | Anshul Patil",
  metadataBase: new URL("https://anshulpatil.dev/blog"),
  description: "Read stories and articles from Anshul Patil's Blog",
  openGraph: {
    title: "Blog | Anshul Patil",
    url: "https://anshulpatil.dev/blog",
    description: "Read stories and articles from Anshul Patil's Blog",
  },
};
